...
> **Note:** This is a re-posted article for research purposes. The original can be found here: [https://x.com/pbteja1998/status/2017662163540971756?s=20](https://x.com/pbteja1998/status/2017662163540971756?s=20)
...
I run [SiteGPT](https://sitegpt.ai), an AI chatbot for customer support. I use AI constantly. But every AI tool I tried had the same problem. No continuity.
...
- **Agent Cards** — status of each agent and what they're working on
...
Each agent needs to know who they are. That's the `SOUL.md` file.
...
**First, load context.** Read `SOUL.md`. Read recent daily notes. Check session memory if needed.
...
Type `@channel` and everyone gets notified.
...
Built by [Bhanu Teja P](https://x.com/pbteja1998) at [SiteGPT](https://sitegpt.ai).

This is all built on [Clawdbot](https://github.com/pbteja1998/clawdbot) (now [OpenClaw](https://github.com/openclaw-org/openclaw)), which is open source. If you build something similar, I'd love to hear about it.
